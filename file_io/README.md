In computing, input/output (I/O, or informally io or IO) is the communication between an
...
outputs are the signals or data sent from it. The term can also be used as part of an action;
